"""The one place `strider` reaches `../ugm`'s engine.
...
workaround is gone and nothing else in `strider` had to know it ever existed.

⭐ It paid off a second time on 2026-08-02, when ugm's restructuring **renamed `microfunctions` to `ugm`**,
the old engine of that name having been retired. The whole of `strider` moved on the four lines below.
